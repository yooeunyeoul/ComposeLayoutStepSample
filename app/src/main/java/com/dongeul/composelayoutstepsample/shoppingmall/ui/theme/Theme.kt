package com.dongeul.composelayoutstepsample.shoppingmall.ui.theme
...
import com.dongeul.composelayoutstepsample.ui.theme.*

private val DarkColorPalette = ShoppingMallColors(
    brand = Shadow1,
...
private val LightColorPalette = ShoppingMallColors(
    brand = Shadow5,
...
fun ShoppingTheme(
    ...
    val colors = if (dartTheme) {
        DarkColorPalette
    } else {
        LightColorPalette
    }
    ProvideShoppingMallColors(colors = colors) {
        MaterialTheme(
            colors = debugColors(dartTheme),
...
@Composable
fun ProvideShoppingMallColors(
    colors: ShoppingMallColors,
    content: @Composable () -> Unit
) {
    ...
    CompositionLocalProvider(LocalShoppingMallColors provides colorPalette, content = content)
}

private val LocalShoppingMallColors = staticCompositionLocalOf<ShoppingMallColors> {
    error("No ShoppingMallColorPallete provided")
}

object ShoppingMallTheme {
    val colors: ShoppingMallColors
        @Composable
        get() = LocalShoppingMallColors.current
}


@Stable
class ShoppingMallColors(
    ...
    fun update(other: ShoppingMallColors) {
    ...
    fun copy(): ShoppingMallColors = ShoppingMallColors(
